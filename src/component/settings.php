...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" data-bs-scroll="true" data-bs-backdrop="true" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header">
        <div class="d-flex align-items-center">
            <h3 class="offcanvas-title me-3" id="offcanvasExampleLabel">ການຕັ້ງຄ່າ</h3>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mt-4 mb-3">ຕົວປັບແຕ່ງສີ</h5>
                ...
                <hr class="hr-horizontal">
                <h5 class="mb-3 mt-4">ທິດທາງໂຄງການ</h5>
                ...
                <div class="d-grid gap-3 grid-cols-2 mb-4">
                    ...
                    <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color" data-value="sidebar-transparent">
                        <span class=""> ໂປ່ງໃສ </span>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <h5 class="mt-4 mb-3">ປະເພດແຖບດ້ານຂ້າງ</h5>
                <div class="d-grid gap-3 grid-cols-3 mb-4">
                    <div class="text-center">
                    ...
                    <div class="text-center">
                        ...
                        <span class="mt-2">ກ່ອງ</span>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <h5 class="mt-4 mb-3">ຮູບແບບການເຄື່ອນໄຫວແຖບດ້ານຂ້າງ</h5>
                <div class="d-grid gap-3 grid-cols-2 mb-4">
                    <div class="text-center">
                        ...
                        <span class="mt-2">ມົນດ້ານໜຶ່ງ</span>
                    </div>
                    <div class="text-center">
                        ...
                        <span class="mt-2">ມົນທັງໝົດ</span>
                    </div>
                    <div class="text-center">
                        ...
                        <span class="mt-2">ຢາດ້ານໜຶ່ງ</span>
                    </div>
                    <div class="text-center">
                        ...
                        <span class="mt-2">ຢາທັງໝົດ</span>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <h5 class="mt-4 mb-3">ແບບ Navbar</h5>
                <div class="d-grid gap-3 grid-cols-2 ">
                    ...
                    <div class="btn btn-border active col-span-full mt-4 d-block" data-setting="navbar" data-name="navbar-default" data-value="default">
                        <span class=""> Navbar ເລີ່ມຕົ້ນ</span>
                    </div>
                </div>
            </div>
        </div>
